...
_TEMPERATURE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='db.Temperature.time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='station', full_name='db.Temperature.station', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='db.Temperature.value', index=2,
...
_ADDREPLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='record_count', full_name='db.AddReply.record_count', index=0,
...
Temperature = _reflection.GeneratedProtocolMessageType('Temperature', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:db.Temperature)
  })
...
AddReply = _reflection.GeneratedProtocolMessageType('AddReply', (_message.Message,), {
  ...
  '__module__' : 'weather_pb2'
  # @@protoc_insertion_point(class_scope:db.AddReply)
  })
...
_WEATHER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='AddTemperature',
    full_name='db.Weather.AddTemperature',
    index=0,
